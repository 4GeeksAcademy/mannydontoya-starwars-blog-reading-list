			...
			<BrowserRouter basename={basename}>
				<ScrollToTop>
					...
					<Routes>
						...
						<Route path="details/characters/:id" element={<peopleDetails />} />
						<Route path="details/planets/:id" element={<planetDetails />} />
						<Route path="details/vehicles/:id" element={<vehicleDetails />} />
